...
class Notifications extends React.Component {
    ...
    convertPropsToFormData(props) {
        const notification = props.formData && props.formData._id
            ? props.formData
            : {};
            ...
            notificationService.create(item)
                .then(data => {
                    ...
                    this.setState(prevState => {
                        const field = {
                            ...prevState.formData._id, _id: data
                        };
                        const formData = {
                            ...prevState.formData, _id: field
                        };
    ...
    render() {
        return (
            <React.Fragment>
                <form>
                    <div className={!this.state.formData.type.valid && this.state.formData.type.touched
                        ...
                        {!this.state.formData.type.valid && this.state.formData.type.touched
                            ? <p className='text-danger'>A type is required.</p> : null}
                    </div>

                    <div className={!this.state.formData.message.valid && this.state.formData.message.touched
                        ? 'form-group has-error' : 'form-group'}>
                        ...
                        <input type='text' name='message' id='message'
                            ...
                            onChange={this.onChange} />
                        {!this.state.formData.message.valid && this.state.formData.message.touched
                            ? <p className='text-danger'>A message is required.</p> : null}
                    </div>
