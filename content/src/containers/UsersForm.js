    ...
    const initializedUser = {
      ...
      isEmailConfirmed:
        typeof user.isEmailConfirmed === "undefined"
          ? ""
          : user.isEmailConfirmed.toString()
    };
          ...
          <fieldset>
            <div className="form-group">
              <div className="row">
                ...
                >
                  <label htmlFor="isEmailConfirmed">
                    Is This Email Confirmed?
                  </label>
                  <select
                    className="form-control"
                    name="isEmailConfirmed"
                    value={this.state.formData.isEmailConfirmed.value}
                    onChange={this.onChange}
                  >
                    <option value="" />
