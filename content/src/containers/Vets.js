...
class Vets extends React.Component {
    ...
    render() {
        const vets = this.state.vets ? this.state.vets.map(vet => (
            <li key={vet._id} onClick={this.onSelect.bind(this, vet)}>{vet.firstName + ' ' + vet.lastName}</li>
        ))
